...
public class VehicleController {
	...
	// @Secured("ROLE_ADMIN")
	@PostMapping("update")
	public String update( Vehicle vehicle, BindingResult result, HttpSession session, Model model) {
	...
	// @Secured("ROLE_ADMIN")
	@PostMapping("add")
	public String add( Vehicle vehicle, BindingResult result, HttpSession session, Model model) {
